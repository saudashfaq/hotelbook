        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Menu Packages</h1>
                            <a href="{{route('client.dashboard.addmenupackage')}}" class="btn btn-primary mt-3">Add Menu</a>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List of All Menu Packages That you have created</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body p-0">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($menuPackage as $key=>$menu_packages)
                                    <tr>
                                        <td></td>
                                        <td>{{$menu_packages->descrtiption}}</td>
                                        <td>{{$menu_packages->price}}</td>
                                        <td>
